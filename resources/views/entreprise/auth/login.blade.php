...
<head>
        ...
        <meta charset="utf-8" />
        <title>Connexion | SWAPECO | Entreprise</title>
                                                ...
                                                <div class="auth-content card-body p-5 h-100 text-white">
                                                    <div class="w-100">
                                                        <div class="text-center mb-4">
                                                            <h5>Connexion</h5>
                                                            <p class="text-white-70">Connectez-vous a votre compte SWAPECO.</p>
                                                        </div>
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Vous n'avez pas de compte ? <a href="{{ url('entrprise/register') }}" class="fw-medium text-white text-decoration-underline"> S'inscrire</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
