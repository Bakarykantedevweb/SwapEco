                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-6 text-center">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="mt-5">
                                                        <img src="{{ asset('front/assets/images/auth/sign-up.png') }}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-lg-6">
                                                <div class="auth-content card-body p-5 text-white">
                                                    <div class="w-100">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="text-white-70">Inscrivez-vous et accédez à toutes les fonctionnalités de SWAPECO</p>
                                                        </div>
                                                        <form action="" class="auth-form" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="emailInput" class="form-label">Mot de passe</label>
                                                            ...
                                                            <div class="text-center">
                                                                <button type="submit" class="btn btn-white btn-hover w-100">Creer mon compte</buttom>
                                                            </div>
                                                        </form>
                                                        <div class="mt-3 text-center">
                                                            <p class="mb-0">Déjà membre ? <a href="{{ url('entreprise/login') }}" class="fw-medium text-white text-decoration-underline"> Se Connecter </a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
