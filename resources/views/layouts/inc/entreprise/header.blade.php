                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                        <div class="dropdown-item">
                            <div class="d-flex">
                                ...
                                <div class="ms-3 lh-1">
                                    <h5 class="mb-1">{{ Auth::guard('entreprise')->user()->nom_complet }}</h5>
                                    <p class="mb-0">{{ Auth::guard('entreprise')->user()->email }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a class="dropdown-item" href="{{ url('entreprise/logout') }}" 
                                onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                    <i class="fe fe-power me-2"></i>
                                    Deconnexion
                                </a>
                                <form id="logout-form" action="{{ url('entreprise/logout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </li>
                        </ul>
