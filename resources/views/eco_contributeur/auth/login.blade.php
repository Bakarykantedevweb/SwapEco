...
<head>
    ...
    <meta charset="utf-8" />
    <title>Connexion | SWAPECO - Contributeur</title>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="auth-content card-body p-5 h-100 text-white">
                                                <div class="w-100">
                                                    ...
                                                    <form
                                                        action="{{ route('contributeur.login.post') }}"
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <p class="mb-0">Vous n'avez pas de compte ? <a href="{{ route('contributeur.register') }}"
