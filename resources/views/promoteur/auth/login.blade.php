...
<!-- Mirrored from preview.pichforest.com/jobvia/layouts/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 17:03:36 GMT -->

<head>


    <meta charset="utf-8" />
    <title>Connexion | SWAPECO - Promoteur </title>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-lg-6 text-center">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="mt-5">
                                                    <img src="{{ asset('front/assets/images/auth/sign-in.png') }}" alt=""
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                            ...
                                            <div class="auth-content card-body p-5 h-100 text-white">
                                                <div class="w-100">
                                                    <div class="text-center mb-4">
                                                        <h5>Bienvenue chers Promoteur </h5>
                                                        <p class="text-white-70">Connectez-vous pour continuer sur SWAPECO.</p>
                                                    </div>
                                                    <form
                                                        action="{{ route('promoteur.login.post') }}"
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="form-check">{{-- <input class="form-check-input"
                                                                ...
                                                                <a href=""
                                                                    class="float-end text-white">Mot de passe oublié?</a>
                                                        ...
                                                        <div class="text-center">
                                                            <button type="submit"
                                                                class="btn btn-white btn-hover w-100">Se connecter</button>
                                                        </div>
                                                    </form>
                                                    <div class="mt-4 text-center">
                                                        <p class="mb-0">Vous n'avez pas de compte ? <a href="{{ route('promoteur.register') }}"
...
<!-- Mirrored from preview.pichforest.com/jobvia/layouts/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 17:03:37 GMT -->
